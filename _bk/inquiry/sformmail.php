...
// 設定
$mail_to = 'info@wakana-p.co.jp'; // フォームデータを受け取るメールアドレス
$mail_subject = 'HPよりお問い合わせ'; // 受け取る時のSubject（件名）
$reply_subject = '株式会社若菜企画へのお問い合わせありがとうございます。'; // 送信者へ自動返信のSubject（件名）
$mail_bcc = ''; // BCCで受け取りが必要な場合は設定
$internal_enc = 'Shift_JIS'; // 文字エンコード
